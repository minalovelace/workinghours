...
class FeiertagWeekend
{
    ...
    private HashMap<Integer, Tag> createWeekendsHolidays()
    {
        ...
        Tag allerheiligenTag = new Tag(allerheiligen, false, false, true, false, false);
        ...
        Tag ersterWTTag = new Tag(ersterWT, false, false, true, false, false);
        ersterWTTag.setKommentar("1. Weihnachtstag");
        tage.put(ersterWT.getDayOfYear(), ersterWTTag);
        /* 2. Weihnachtstag */
        Datum zweiterWT = new Datum(m_jahr, 12, 26);
        Tag zweiterWTTag = new Tag(zweiterWT, false, false, true, false, false);
        ...
        Tag ostersonntagTag = new Tag(new Datum(ostersonntag), false, false, true, false, false);
        ...
        Tag ostermontagTag = new Tag(new Datum(ostermontag), false, false, true, false, false);
        ...
        Tag karfreitagTag = new Tag(new Datum(karfreitag), false, false, true, false, false);
        ...
        Tag christihimmelTag = new Tag(new Datum(christihimmel), false, false, true, false, false);
        ...
        Tag pfingstsonntagTag = new Tag(new Datum(pfingstsonntag), false, false, true, false, false);
        ...
        Tag pfingstmontagTag = new Tag(new Datum(pfingstmontag), false, false, true, false, false);
        ...
        Tag fronleichnamTag = new Tag(new Datum(fronleichnam), false, false, true, false, false);
        ...
        while (cal.get(GregorianCalendar.YEAR) == m_jahr)
        {
            ...
            case GregorianCalendar.SUNDAY:
                Tag wochenende = new Tag(new Datum(cal), false, false, false, false, true);
